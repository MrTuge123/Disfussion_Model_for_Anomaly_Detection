...
For every combination the script:
  ...
  4. Saves four plots per run in result_0323/<run_index>/
  5. Writes summary CSV + JSON to result_0323/
"""
...
def run_single(hp, df_train, df_polymer_test, df_amb, df_test,
    ...
    # Validation-percentile threshold sweep (maximise F1)
    best_f1, best_thresh_lp = 0.0, np.percentile(val_lp, 5)
